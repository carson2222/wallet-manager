...
type TransactionSenderAndConfirmationWaiterArgs = {
  ...
  blockhashWithExpiryBlockHeight: web3.BlockhashWithExpiryBlockHeight;
};
...
}: TransactionSenderAndConfirmationWaiterArgs): Promise<web3.VersionedTransactionResponse | null> {
